...
Bonusy a postihy se dělí do čtyř rozličných typů. Důležité je, že bonusy stejného typu (mimo těch bez typu) se vzájemně nesčítají, vždy se bere jen nejvyšší hodnota. To samé platí i pro postihy. Typy jsou následující: 

- **Situační:** Vzniká většinou ze situace. Například schování se v zákrytu před střelami může poskytovat situační bonus do OČ. Všechny modifikátory vzniklé na základě chvilkového rozhodnutí PJ jsou situační.
- **Stavový:** Vzniká většinou z magického efektu. Nebo nějaké jiné formy dočasného posílení či oslabení.
- **Předmětový:** Vzniká za pomocí předmětů. Například meč +1 poskytuje předmětový bonus +1 k zásahu a poškození.
- **Bez typu:** Modifikátory, které nemají typ, se mohou neomezeně sčítat mezi sebou a i ostatními modifikátory. Příklady takových modifikátorů je například modifikace za dovednost, um nebo modifikátor zásahu za specializaci.
...
| ------------- | :--------------- | :----------------------------------------------------------- |
| **Výdrž**     | **Zdatnost** | *Okamžitá smrt, působení jedů, nemoci, kouzla cílíc na vitalitu jedince*           |
| **Obratnost** | **Reflexy** | *Spuštění pasti, záchyt při pádu z výšky, speciální schopnosti monster a efekty, kterým se lze obratností vyhnout* |
