...
13. **Zbraňová specializace** - Postava má bonus *+1* k zásahu a poškození se specifickým typem zbraní, který si vybere (Například: Obou-ruční sekera, kuše, nůž atd...). Tento talent si lze vzít opakovaně pro různé typy zbraní.
