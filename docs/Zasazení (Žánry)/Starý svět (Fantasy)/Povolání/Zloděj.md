...
- **Přepadení:** Asasín může použít schopnost přepadení s libovolnou zbraní (včetně střelných) a pro splnění podmínek stačí, když si cíl není vědom asasínovi přítomnosti (opakované schování se v probíhajícím boji však stále nestačí). Pokud navíc asasín zasáhne cíl z přepadení, cíl musí uspět v *záchraném hodu proti smrti* modifikovaný postihem ve výši *polovinou úrovně asasína*, jinak zemře. V případě úspěchu cíl obdrží pouze poškození za přepadení.
