...
Postava může mít maximálně *8+Modifikátor Síly* slotů vybavených předmětů a maximálně *15+Modifikátor Síly* slotů uschovaných předmětů v inventáři. 
...
I střelné zbraně jsou řazeny do stejných kategorií jako zbraně na blízku. Jejich velikost však určuje i jejich efektivní dostřel.

- **Malá střelná** - má efektivní dostřel do vzdálenosti *25 metrů* (Poblíž) 
