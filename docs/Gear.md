...
- **Těžká** - Omezuje v pohybu, nedá se v ní spát ani plížit, *bonus k OČ ze zručnosti je poloviční* (zaokrouhleno nahoru) a *snižuje hybnost o 1 metr*.
- **Velmi těžká** - Omezuje v pohybu, nedá se v ní spát ani plížit, *bonus k OČ ze zručnosti je negován* a *snižuje hybnost o 2 metry*. Tento typ zbroje je také velmi často vyráběn na míru nositele. Jeho cena je tedy nesrovnatelně vyšší než u ostatních typů zbrojí.
...
| Nůž             |    Malá    |      1k4       |   1   | 3 st  |
| Obouruční meč   |   Velká    | 1k10+1 (1k8+1) |   3   | 50 st |
...
**Hůl:** Dřevěná hůl, magická hůl nebo jen delší klacek. *Speciální:* Zbraň nevyžaduje trénink. Kdokoliv ji může použít.

**Kopí:** Dlouhá dřevěná tyč s bodcem. *Speciální:* Pokud použito na koni, stačí držet v jedné ruce. 

**Kosa:** Původní farmářská zbraň překovaná do děsivé avšak ne příliš efektivní zbraně. Tato zbraň bývá preferována pouze akolytama Nekrofose. *Speciální:* Poškození zbraně se hází s nevýhodou.
...
**Obouruční meč:** Masivní meč jehož hlavní výhodou oproti jiným těžkým zbraním je jeho verzatilní využití. Obouruční meč je vhodný jak jako sečná tak i bodná zbraň. *Speciální:* Bodná poškození obouručním mečem působí 1k8+1 poškození; Kritický zásah obouručním mečem shodí nepřítele na zem.
...
**Sekyrka:** Malá příruční sekyrka. Vhodná především na házení. *Speciální:* Lze hodit (jen na efektivní vzdálenost).
...
**Šakram:** Malá kruhová čepel s úchytem. Tato zbraň bývá preferována především akolytama Uldumura. *Speciální:* Lze hodit (jen na efektivní vzdálenost); Při neúspěšném hodu na zásah (při hození) lze podstoupit ověření zručnosti s HU 6. Úspěch znamená, že se šakram odrazem vrátil zpět do rukou toho, kdo jej hodil. 
...
| Granát                |    Malá    |  Hozený  |  2k6 oblast   |  1   | 50 st  |
...
**Granát:** Výbušná kovová koule se zápalným knotem. Od zapálení knotu exploduje do 6-ti vteřin. Vzniklá exploze způsobí 2k6 poškození v oblasti 2 metrů kolem výbuchu. Zasažené cíle se mohou pokusit o záchranný hod na úhyb, aby zredukovali poškození na polovinu. *Speciální:* Při hození na dálku se před výbuchem odkutálí 1k2 metrů náhodným směrem.
...
**Kuše:** Mechanické zařízení s integrovanou menší verzí luku a jednoduchou spouští. Často preferovaná díky své konzistentnosti, přesnosti a tichosti.
...
**Šíp "Kladivoun":** Šíp s tupou hlavicí. Působí tupé poškození o stupeň nižší kostkou. Při kritickém zásahu způsobí omráčení na 1 kolo. Speciální šípy lze použít pouze do středních a větších luků a kuší.

**Šíp "Otvírák":** Speciálně upravený šíp na lovení ryb. Lze ním střílet bez postihů do vody až do hloubky 5 metrů. Speciální šípy lze použít pouze do středních a větších luků a kuší.

**Šíp s lankem:** Šíp s 6-ti metrovým lankem, který se bezpečně přichytí k jakémukoliv měkčímu pevnému povrchu (např. dřevo). Šípem lze, vzhledem k jeho váze, střílet jen na polovinu efektivní vzdálenosti. Speciální šípy lze použít pouze do středních a větších luků a kuší.

**Šíp s loveckým hrotem:** Šíp se speciálně upravenou hlavicí. Působí sečné poškození o stupeň nižší kostkou. Při kritickém zásahu způsobí krvácení. Krvácení působí 1k4 poškození po dobu dvou kol nebo dokud není krvácení zastaveno. Speciální šípy lze použít pouze do středních a větších luků a kuší.

**Výbušný šíp:** Šíp s explozivní hlavicí. Při dopadu vybouchne a udělí 3k6 poškození všem cílům v okruhu 1 metru kolem místa dopadu. Zasažení mohou podstoupit záchranný hod na úhyb pro zredukování poškození na polovinu. Pokud je šípem někdo zasažen přímo, nemá nárok na záchranný hod, a obdrží plné poškození. Šípem lze, vzhledem k jeho váze, střílet jen na polovinu efektivní vzdálenosti. Speciální šípy lze použít pouze do středních a větších luků a kuší.

**Zápalný šíp:** Šíp s hlavicí speciálně uzpůsobenou na to aby mohla být zapálena. Pokud má zasažený cíl na sobě hořlavý materiál, tak začne při zásahu hořet. Po dobu 2 kol (nebo dokud není uhašen) obdrží cíl 1k4 poškození. Šípem lze, vzhledem k jeho váze, střílet jen na polovinu efektivní vzdálenosti. Speciální šípy lze použít pouze do středních a větších luků a kuší.
...
**Spacák:** Pro příjemnější spaní v divočině v horších povětrnostních podmínkách.
...
Hráči mohou mít v průběhu hry přístup k nejrůznějším jedům. Prodej jedů však není úplně běžný. Pokud si tedy chtějí hráči jed obstarat, musí se obrátit na černý trh nebo jiné ne úplně legální organizace.
...
Oběť otravy musí podstoupit záchranný hod proti danému jedu s modifikátorem závislým na síle jedu. Efekt samotného jedu pak závisí na úspěchu či neúspěchu v záchranném hodu a tom jestli byl jed pozřen nebo vstoupil do těla zraněním.  
...
**Onset** - Doba, než jed začne působit 
